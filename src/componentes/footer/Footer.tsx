  ...
  return(
    <footer className="rodape">
      <div className='bloco1'>
        ...
        <p className='p1'>Aqui no site da Ellen, você encontra tudo sobre mim! <br /> Portfólio da Ellen - Conhecimento em Destaque. <br /> Do Aprendizado à Excelência, com Ellen você encontra! </p>
